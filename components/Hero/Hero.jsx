...
const Hero = () => {
    return (
        <div className="h-screen bg-desktopHero bg-cover bg-center small:bg-mobileHero small:h-33.625rem">
            <Header />
            ...
            <div className='flex justify-center mt-6.03rem small:mt-4.5rem'>
