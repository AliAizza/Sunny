...
const Reviews = () => {
    return (
        <div className='flex flex-col items-center py-40 gap-20 overflow-hidden 1150:py-16 1150:gap-16 bg-menuBackground'>
            ...
            <div className='flex items-center w-screen justify-around 1150:flex-col 1150:justify-normal 1150:gap-16'>
                {
                    feedbacks.map((feedback, index) => (
                        <div key={index} className='flex flex-col items-center text-center 1150:px-6'>
                            ...
                            <p className=' max-w-21.875rem text-clientsFeedbacks font-sec font-semibold text-1.125rem mb-4.31rem 1150:mb-8'>{feedback.review}</p>
